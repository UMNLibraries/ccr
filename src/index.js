...
var miradorInstance = Mirador.viewer({
  ...
  windows: [
  {
    manifestId: 'https://cdm16022.contentdm.oclc.org/iiif/info/p16022coll228/1552/manifest.json',
    thumbnailNavigationPosition: 'far-bottom'
  },
  {
    manifestId: 'https://collections.carli.illinois.edu/iiif/info/nby_dig/15132/manifest.json',
    thumbnailNavigationPosition: 'far-bottom'
  }
  ],
  window: {
